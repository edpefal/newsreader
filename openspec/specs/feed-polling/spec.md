...
Fetch y parseo centralizado de feeds RSS/Atom del lado del servidor (Edge Function), disparado on-demand por pull-to-refresh o por login, con dedupe garantizado por constraint de base de datos y generación de ids de artículo en el servidor.
