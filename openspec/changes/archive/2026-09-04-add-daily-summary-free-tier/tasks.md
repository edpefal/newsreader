...
- [x] 7.3 Correr `flutter analyze` y `flutter test` localmente antes de subir la rama (hecho, ambos en verde); abrir PR y esperar el check `analyze-and-test` en verde antes de mergear (ver flujo de trabajo en CLAUDE.md). PR #16 mergeado 2026-09-03; PR #17 (fix de copy "resúmenes ilimitados" → "un resumen todos los días") mergeado 2026-09-04.
