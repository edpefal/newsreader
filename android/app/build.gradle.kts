...
android {
    ...
    buildTypes {
        release {
            // Firma con el keystore de release (android/key.properties, fuera
            // de git) si existe; si no (ej. CI sin el archivo), cae al
            // signing de debug para que `flutter run --release` no rompa.
